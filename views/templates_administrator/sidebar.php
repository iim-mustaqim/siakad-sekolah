  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-2">Sisfo-Akademik</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('administrator/tingkatan')?>">Tingkatan</a>
            ...
            <a class="collapse-item" href="<?php echo base_url('administrator/jadwal')?>">Jadwal</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="404.html">Mata Pelajaran Sekolah</a>
            <a class="collapse-item" href="blank.html">Galery</a>
            <a class="collapse-item" href="404.html">Kontak Kami</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
