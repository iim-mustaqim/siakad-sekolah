<div class="container-fluid">
  ...
  <i class="fas fa-tachometer-alt"></i> Dashboard - Sistem Informasi Akademik Vickery School
  </div>
  
  <div class="alert alert-success" role="alert">
  <h4 class="alert-heading">Selamat Datang!</h4>
  <p>Selamat Datang <strong><?php echo $username; ?></strong> di Sistem Informasi Akademik Sekolah Vickery, Anda Login Sebagai <strong><?php echo $level; ?></strong></p>
  <hr>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/siswa')?>"><p class="nav-link small text-info">SISWA</p></a>
          ...
          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/tingkatan')?>"><p class="nav-link small text-info">TINGKATAN</p></a>
            <i class="fas fa-3x fa-archway"></i>
          </div>

          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/kelas')?>"><p class="nav-link small text-info">KELAS</p></a>
            <i class="fas fa-3x fa-door-closed"></i>
          </div>
        </div><hr>
          <div class="row">
          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/guru')?>"><p class="nav-link small text-info">GURU</p></a>
            <i class="fas fa-3x fa-user-tie"></i>
          </div>

          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/matapelajaran')?>"><p class="nav-link small text-info">MATA PELAJARAN</p></a>
        ...
        <div class="row">
          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url('administrator/jadwal')?>"><p class="nav-link small text-info">JADWAL</p></a>
          ...
          <div class="col-md-3 text-info text-center">
            <a href="<?php echo base_url()?>"><p class="nav-link small text-info">INFORMASI SEKOLAH</p></a>
